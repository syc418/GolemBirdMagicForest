...
IL_0066:
	{
		...
		int32_t L_14 = __this->get_RunKey_4();
		bool L_15 = Input_GetKey_mFDD450A4C61F2930928B12287FFBD1ACCB71E429(L_14, /*hidden argument*/NULL);
		if (!L_15)
		{
			goto IL_008e;
		}
	}
	{
		...
		float L_16 = __this->get_CurrentTargetSpeed_7();
		float L_17 = __this->get_RunMultiplier_3();
		__this->set_CurrentTargetSpeed_7(((float)il2cpp_codegen_multiply((float)L_16, (float)L_17)));
		// m_Running = true;
...
// System.Boolean UnityStandardAssets.Characters.FirstPerson.RigidbodyFirstPersonController_MovementSettings::get_Running()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool MovementSettings_get_Running_mC0E0B56E8087939B31F1E4C1ABDF63FAC40AF029 (MovementSettings_t52D9101B6792CA6CFBAFD46643413D326E655960 * __this, const RuntimeMethod* method)
{
	{
